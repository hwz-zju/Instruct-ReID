...
from .data.preprocessor_cc import PreProcessor
...
class DataBuilder_cc(object):
    def __init__(self, args, task_info=None):
        super(DataBuilder_cc, self).__init__()
        self.args = args
    ...
    def _build_test_loader(self, query_dataset, gallery_dataset):
        ...
        test_loader = DataLoader(PreProcessor(test_set, root=data_root, 
                                              root_additional=None, transform=test_transformer,
