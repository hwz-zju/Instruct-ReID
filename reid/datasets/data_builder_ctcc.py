...
from .data.preprocessor_ctcc import PreProcessor
...
class DataBuilder_ctcc(object):
    def __init__(self, args, task_info=None):
        super(DataBuilder_ctcc, self).__init__()
        self.args = args
    ...
    def _build_train_loader(self, dataset):
        if self.args.colorjitter =='all':
            ...
            train_clothes_transformer = T.Compose([
                T.Resize((self.args.width_clo, self.args.width_clo)),
                T.RandomCrop((self.args.width_clo, self.args.width_clo)),
                T.ToTensor(),
        ...
        train_loader = DataLoader(PreProcessor(dataset, root=data_root,
    ...
    def _build_test_loader(self, query_dataset, gallery_dataset):
        ...
        test_loader = DataLoader(PreProcessor(test_set, root=data_root, root_additional=None, 
