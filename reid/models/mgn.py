...
from reid.models.backbone.resnet_ibn_a import Bottleneck
...
class MGN(nn.Module):
    ...
    def __init__(self, num_classes=0, net_config=None):
        super(MGN, self).__init__()
        self.num_classes = num_classes

        feats = 256
        resnet = MGN.__factory['50a'](pretrained=True)
        ...
        if num_classes > 0:
            ...
            self.classifiers = [self.fc_id_2048_0,self.fc_id_2048_1,self.fc_id_2048_2,self.fc_id_256_1_0,
                            self.fc_id_256_1_1,self.fc_id_256_2_0,self.fc_id_256_2_1,self.fc_id_256_2_2]
    ...
    def forward(self, x, label=None):
        ...
        if self.num_classes:
            ...
            return [fg_p1, fg_p2, fg_p3], None,  [l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3]


def mgn(*args, **kwargs):
    return MGN(*args, **kwargs)
