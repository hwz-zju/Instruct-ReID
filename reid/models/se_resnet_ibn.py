...
from reid.models.backbone.se_resnet_ibn import se_resnet101_ibn_a as se

__all__ = ['se_resnet101_ibn_a']
...
def se_resnet101_ibn_a(**kwargs):
    return ResNet_IBN('', **kwargs)
