...
model_urls = {
    'se_resnet101_ibn_a': './logs/pretrained/se_resnet101_ibn_a.pth.tar',
}
...
def se_resnet101_ibn_a(pretrained=False):
    ...
    if pretrained:
        state_dict = torch.load(model_urls['se_resnet101_ibn_a'], map_location=torch.device('cpu'))
