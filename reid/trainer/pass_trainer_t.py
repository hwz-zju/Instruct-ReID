...
class GeneralTransformerTrainer_t2i(BaseTrainer):
    ...
    def run(self, inputs):
        ...
        sim_i2t = feat @ clot_feats_s.t() / self.model.module.temp
        sim_t2i = clot_feats_s @ feat.t() / self.model.module.temp
        sim_i2i = feat @ feat.t() / self.model.module.temp
        sim_t2t = clot_feats_s @ clot_feats_s.t() / self.model.module.temp
        ...
        if self.args.fusion_loss=='all':
            if 'bio' in self.args.fusion_branch and 'clot' in self.args.fusion_branch:
                ...
                loss = 1*loss_cl + 1*loss_ce_biometric + loss_ce_vl
